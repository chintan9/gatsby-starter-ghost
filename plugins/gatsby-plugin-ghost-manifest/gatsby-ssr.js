...
exports.onRenderBody = function(_ref, pluginOptions) {
  ...
  // We use this to build a final array to pass as the argument to
  // setHeadComponents at the end of onRenderBody.
  var headComponents = [];
  var icons =
      pluginOptions.icons ||
      _common.defaultIcons; // If icons were generated, also add a favicon link.
  ...
  })); // The user has an option to opt out of the theme_color meta tag being
       // inserted into the head.

  if (pluginOptions.theme_color) {
    var insertMetaTag =
        Object.keys(pluginOptions).includes("theme_color_in_head")
