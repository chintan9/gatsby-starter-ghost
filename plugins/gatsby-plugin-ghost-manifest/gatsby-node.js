...
var _extends2 =
    _interopRequireDefault(require("@babel/runtime/helpers/extends"));
...
var _require = require("./common.js"), defaultIcons = _require.defaultIcons,
...
exports.onPostBuild = /*#__PURE__*/ function() {
  var _ref =
      (0, _asyncToGenerator2
              .default)(/*#__PURE__*/ _regenerator.default.mark(function
                                                                    _callee(
                                                                        _ref2,
                                                                        pluginOptions) {
                                                                      var graphql,
                                                                            ...
                                                                            while (
                                                                              ...
                                                                              case 4:
                                                                                ...
                                                                                delete manifest
                                                                                    .theme_color_in_head;
                                                                                delete manifest
                                                                                    .query; // If icons are not manually defined, use the default icon set.
                                                                                ...
                                                                                iconPath = path.join(
                                                                                    ...
                                                                                    path.dirname(
                                                                                        manifest
                                                                                            .icons
                                                                                                [0]
                                                                                            .src)); // create destination directory if it doesn't exist
                                                                                ...
                                                                                fs.writeFileSync(
                                                                                    ...
                                                                                    JSON.stringify(
                                                                                        manifest)); // Only auto-generate icons if a src icon is defined.
